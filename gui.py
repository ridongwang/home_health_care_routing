...
class AddNewPatient:
    ...
    def __init__(self, root, patient, time):
    ...
    def add_to_day_schedule(self):
        ...
        self.patient.window_open = self.start_time
        self.patient.window_close = self.end_time
        self.patient.care_duration = self.duration
        self.patient.type_of_patient = self.type
        self.patient.patient_priority = self.priority
...
#         self.patient = PatientData()
#         self.time = 0
#         self.add_new_patient_screen = AddNewPatient(self.patient, self.time)
    
#     def show(self):
#         self.main_screen.display_screen()
